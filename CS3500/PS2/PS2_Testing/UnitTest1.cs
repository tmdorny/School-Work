...
namespace PS2GradingTests
{
    ...
    public class DependencyGraphTest
    {
        ...
        // ********************************** MY PERSONAL TESTS ******************** // Tim Dorny

        /// <summary>
        ///Replace on a DG 
        ///</summary>
        [TestMethod()]
        public void ReplaceDependencyTest1()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("a", "b");
            t.AddDependency("a", "c");
            t.AddDependency("d", "c");
            t.ReplaceDependents("a", new HashSet<string>() { "t", "u", "v" });
            HashSet<String> aDeps = new HashSet<string>(t.GetDependents("a"));
            Assert.IsTrue(aDeps.SetEquals(new HashSet<string>() { "t", "u", "v" }));
        }

        /// <summary>
        ///Test(s) replacing dependents(2) vs dependees(3)
        ///</summary>
        [TestMethod()]
        public void ReplaceDependencyTest2()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("a", "b");
            t.AddDependency("a", "c");
            ...
            t.AddDependency("a", "v");
            t.AddDependency("a", "h");
            t.ReplaceDependents("a", new HashSet<string>() { "t", "u", "v", "w", "x", "y", "z" });
            HashSet<String> aDeps = new HashSet<string>(t.GetDependents("a"));
            Assert.IsTrue(aDeps.SetEquals(new HashSet<string>() { "t", "u", "v", "w", "x", "y", "z" }));
        }

        /// <summary>
        /// Continuation of previous test this one testing replaceDependees
        /// </summary>
        [TestMethod()]
        public void ReplaceDependencyTest3()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("b", "a");
            t.AddDependency("c", "a");
            ...
            t.AddDependency("t", "a");
            t.AddDependency("z", "a");
            t.ReplaceDependees("a", new HashSet<string>() { "t", "u", "v", "w", "x", "y", "z" });
            HashSet<String> aDees = new HashSet<string>(t.GetDependees("a"));
            Assert.IsTrue(aDees.SetEquals(new HashSet<string>() { "t", "u", "v", "w", "x", "y", "z" }));
        }

        /// <summary>
        ///testing with lots of dependent and dependee references. Small replacement sets
        ///</summary>
        [TestMethod()]
        public void ReplaceDependencyTest4()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("a", "b");
            t.AddDependency("b", "a");
            ...
            t.AddDependency("a", "v");
            t.AddDependency("h", "a");
            t.ReplaceDependents("a", new HashSet<string>() { "t" });
            HashSet<String> aDeps = new HashSet<string>(t.GetDependents("a"));
            Assert.IsTrue(aDeps.SetEquals(new HashSet<string>() { "t" }));

            t.ReplaceDependees("a", new HashSet<string>() { "t", "d" });
            HashSet<String> aDees = new HashSet<string>(t.GetDependees("a"));
            Assert.IsTrue(aDees.SetEquals(new HashSet<string>() { "t", "d" }));
        }

        /// <summary>
        ///Replace on an empty graph
        ///</summary>
        [TestMethod()]
        public void ReplaceDependencyTest5()
        {
            DependencyGraph t = new DependencyGraph();
        ...
        /// <summary>
        ///Basic Size test with remove method
        ///</summary>
        [TestMethod()]
        public void SizeTest2()
        {
            ...
            t.AddDependency("y", "c");
            t.AddDependency("u", "c");
            t.RemoveDependency("u", "c");
            t.RemoveDependency("y", "c");
            t.RemoveDependency("a", "c");
            Assert.AreEqual(7, t.Size);
        }

        /// <summary>
        /// Test size when replacing with less dependencies than initially stored
        /// </summary>
        [TestMethod()]
        public void SizeTest3()
        {
            ...
            t.AddDependency("m", "a");
            t.AddDependency("q", "a");
            t.ReplaceDependees("a", new HashSet<string>() { "t", "u"});
            Assert.AreEqual(2, t.Size);
        }

        /// <summary>
        /// Test size when replacing with more dependencies than initailly stored
        ///</summary>
        [TestMethod()]
        public void SizeTest4()
        {
            ...
            t.AddDependency("a", "e");
            t.AddDependency("b", "e");
            t.ReplaceDependents("a", new HashSet<string>() { "r", "q", "e", "i", "o", "l", "n", "b", "j", "c", "s", "t", "u", "v", "w", "x", "y", "z" });
            Assert.AreEqual(19, t.Size);
        }

        /// <summary>
        /// Test adding and removing outlier cases
        ///</summary>
        [TestMethod()]
        public void addRemoveTest1()
        {
            ...
            HashSet<String> aDeps = new HashSet<string>(t.GetDependents("b"));
            Assert.IsTrue(aDeps.SetEquals(new HashSet<string>() { "a", "b"}));
