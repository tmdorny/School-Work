...
namespace SpreadsheetUtilities
{
    ...
    public class DependencyNode
    {
        ...
        public HashSet<string> getDependentStrings()
        {
            // List to store string "names" of nodes
            HashSet<string> dependentStrings = new HashSet<string>();
        ...
        public HashSet<string> getDependeeStrings()
        {
            // List to store string "names" of nodes
            HashSet<string> dependeeStrings = new HashSet<string>();
            foreach (DependencyNode n in this.dependees)
            {
                // Add each node name to hashSet
