...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_WelcomeScreen_t, stringdata) + ofs \
...
const QMetaObject WelcomeScreen::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_WelcomeScreen.data,
      qt_meta_data_WelcomeScreen,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WelcomeScreen.stringdata))
